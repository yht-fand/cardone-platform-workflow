 ...
 */
@Log4j2
@Component("/vx/workflow/wfVariableUser/m0003.json")
public class M0003Func implements Func1<Object, Map<String, Object>> {
    ...
    @Value("${app.root}/config/api/vx/workflow/wfVariableUser/m0004.output.json")
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(WfVariableUserService.class).findOne(newInputMap);
