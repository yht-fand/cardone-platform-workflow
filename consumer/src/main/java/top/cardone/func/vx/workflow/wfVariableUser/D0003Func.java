 ...
 */
@Log4j2
@Component("/vx/workflow/wfVariableUser/d0003.json")
public class D0003Func implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String wfVariableUserIds = MapUtils.getString(inputMap, "wfVariableUserIds");

        if (StringUtils.isBlank(wfVariableUserIds)) {
            throw new CodeException("工作流变量与用户标识集合不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        return ApplicationContextHolder.getBean(WfVariableUserService.class).deleteByIdsCache(newInputMap);
    }
}