...
public class WfVariableUserController {
	 ...
	 * /c0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/c0001.input.json")
	...
	public Object c0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(WfVariableUserService.class).insertByNotExistsCache(inputMap);
	 ...
	 * /c0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/c0002.input.json")
	 ...
	 * /c0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/c0003.input.json")
	 ...
	 * /c0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/c0004.input.json")
	 ...
	 * /d0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/d0001.input.json")
	...
	public Object d0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(WfVariableUserService.class).deleteByIdsCache(inputMap);
	 ...
	 * /d0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/d0002.input.json")
	 ...
	 * /d0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/d0003.input.json")
	 ...
	 * /d0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/d0004.input.json")
	 ...
	 * /m0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/m0001.input.json")
	...
	public Object m0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(WfVariableUserService.class).findOne(inputMap);
	 ...
	 * /m0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/m0002.input.json")
	 ...
	 * /m0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/m0003.input.json")
	 ...
	 * /m0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/m0004.input.json")
	 ...
	 * /r0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/r0001.input.json")
	private String r0001InputJson;

	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/r0001.output.json")
	...
	public Object r0001Json(HttpServletRequest request) {
		...
		Page<Map<String, Object>> page = ApplicationContextHolder.getBean(WfVariableUserService.class).page(inputMap);
	 ...
	 * /r0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/r0002.input.json")
	private String r0002InputJson;

	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/r0002.output.json")
	 ...
	 * /r0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/r0003.input.json")
	private String r0003InputJson;

	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/r0003.output.json")
	 ...
	 * /r0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/r0004.input.json")
	private String r0004InputJson;

	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/r0004.output.json")
	 ...
	 * /u0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/u0001.input.json")
	...
	public Object u0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(WfVariableUserService.class).updateCache(inputMap);
	 ...
	 * /u0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/u0002.input.json")
	 ...
	 * /u0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/workflow/wfVariableUser/u0003.input.json")
	...
	public Object modifyModalJson(HttpServletRequest request) {
		...
		Map<String, Object> returnData = ApplicationContextHolder.getBean(WfVariableUserService.class).findOneByWfVariableUserId(inputMap.get("wfVariableUserId"));
