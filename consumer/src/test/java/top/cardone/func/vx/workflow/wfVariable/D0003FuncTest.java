...
public class D0003FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariable/D0003FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariable/D0003FuncTest.func.output.json")
