...
public class C0003FuncTest {
    ...
    @Value("${app.root}/src/test/resources/top/cardone/func/vx/workflow/wfTaskHandle/C0003FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/workflow/wfTaskHandle/C0003FuncTest.func.output.json")
