package top.cardone.func.vx.workflow.wfTaskHandle;
...
public class ModifyModalFuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/vx/workflow/wfTaskHandle/modifyModal.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/vx/workflow/wfTaskHandle/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/vx/workflow/wfTaskHandle/ModifyModalFuncTest.func.output.json")
