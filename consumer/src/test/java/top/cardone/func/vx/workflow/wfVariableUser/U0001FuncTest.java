...
public class U0001FuncTest {
    @Value("http://localhost:${server.port:8765}/${server.context-path:}/vx/workflow/wfVariableUser/u0001.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/workflow/wfVariableUser/U0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/workflow/wfVariableUser/U0001FuncTest.func.output.json")
