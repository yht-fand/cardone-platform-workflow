...
public class U0001FuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/vx/workflow/wfVariable/u0001.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/vx/workflow/wfVariable/U0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/vx/workflow/wfVariable/U0001FuncTest.func.output.json")
