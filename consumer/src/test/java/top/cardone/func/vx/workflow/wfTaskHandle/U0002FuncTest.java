...
public class U0002FuncTest {
    @Value("http://localhost:${server.port:8765}${server.context-path:}/vx/workflow/wfTaskHandle/u0002.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/workflow/wfTaskHandle/U0002FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/workflow/wfTaskHandle/U0002FuncTest.func.output.json")
