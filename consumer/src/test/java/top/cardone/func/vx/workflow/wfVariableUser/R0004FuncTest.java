...
public class R0004FuncTest {
    @Value("http://localhost:${server.port:8765}/cardone-workflow/vx/workflow/wfVariableUser/r0004.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariableUser/R0004FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariableUser/R0004FuncTest.func.output.json")
