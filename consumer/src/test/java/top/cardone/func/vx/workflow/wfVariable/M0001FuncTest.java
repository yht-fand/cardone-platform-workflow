...
public class M0001FuncTest {
    @Value("http://localhost:${server.port:8765}/cardone-workflow/vx/workflow/wfVariable/m0001.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariable/M0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariable/M0001FuncTest.func.output.json")
