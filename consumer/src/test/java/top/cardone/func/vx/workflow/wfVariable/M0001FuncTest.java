...
public class M0001FuncTest {
    ...
    @Value("${app.root}/src/test/resources/top/cardone/func/vx/workflow/wfVariable/M0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/workflow/wfVariable/M0001FuncTest.func.output.json")
