...
public class IndexFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariableUser/IndexFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariableUser/IndexFuncTest.func.output.json")
