...
public class AddModalFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariableUser/AddModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariableUser/AddModalFuncTest.func.output.json")
