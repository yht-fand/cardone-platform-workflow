...
public class C0002FuncTest {
    ...
    @Value("${app.root}/src/test/resources/top/cardone/func/vx/workflow/wfVariable/C0002FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/workflow/wfVariable/C0002FuncTest.func.output.json")
