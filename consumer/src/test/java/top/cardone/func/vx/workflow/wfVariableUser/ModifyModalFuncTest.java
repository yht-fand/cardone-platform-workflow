...
public class ModifyModalFuncTest {
    @Value("http://localhost:${server.port:8765}/cardone-workflow/vx/workflow/wfVariableUser/modifyModal.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariableUser/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariableUser/ModifyModalFuncTest.func.output.json")
