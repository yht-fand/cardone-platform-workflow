...
public class IndexFuncTest {
    @Value("http://localhost:${server.port:8765}/cardone-workflow/vx/workflow/wfVariable/index.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariable/IndexFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/workflow/wfVariable/IndexFuncTest.func.output.json")
