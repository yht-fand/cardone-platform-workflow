...
xcopy provider\target\cardone-workflow-provider-*.jar dist\production\provider /Y/C/R/I
...
xcopy consumer\target\cardone-workflow-consumer-*.jar dist\production\consumer /Y/C/R/I
pause