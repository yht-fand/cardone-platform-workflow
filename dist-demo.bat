...
xcopy provider\target\cardone-workflow-provider-*.jar dist\demo\provider /Y/C/R/I
...
xcopy consumer\target\cardone-workflow-consumer-*.jar dist\demo\consumer /Y/C/R/I
pause