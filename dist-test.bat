...
xcopy provider\target\cardone-workflow-provider-*.jar dist\test\provider /Y/C/R/I
...
xcopy consumer\target\cardone-workflow-consumer-*.jar dist\test\consumer /Y/C/R/I
pause