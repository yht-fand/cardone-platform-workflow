...
public class AddModalFuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/v1/workflow/wfTaskHandle/addModal.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/v1/workflow/wfTaskHandle/AddModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/v1/workflow/wfTaskHandle/AddModalFuncTest.func.output.json")
