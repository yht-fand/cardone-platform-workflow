...
${prefixName?string('SET ', ', ')}"business_code" = :update_businessCode_value
<#assign prefixName = false>
</#if>
<#if (update_businessId??)>
${prefixName?string('SET ', ', ')}"business_id" = :update_businessId_value
<#assign prefixName = false>
</#if>
<#if (update_businessTypeCode??)>
${prefixName?string('SET ', ', ')}"business_type_code" = :update_businessTypeCode_value
<#assign prefixName = false>
</#if>
...
${prefixName?string('SET ', ', ')}"wf_task_handle_id" = :update_wfTaskHandleId_value
<#assign prefixName = false>
</#if>
<#include "where.ftl">