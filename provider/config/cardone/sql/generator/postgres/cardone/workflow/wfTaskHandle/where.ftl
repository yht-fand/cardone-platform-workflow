...
${prefixName?string('WHERE ', 'AND ')}"business_code" = :where_and_eq_businessCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("business_code" IS NULL OR "business_code" = '')
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_businessId??)>
<#if (where_and_eq_businessId_value??)>
${prefixName?string('WHERE ', 'AND ')}"business_id" = :where_and_eq_businessId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("business_id" IS NULL OR "business_id" = '')
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_businessTypeCode??)>
<#if (where_and_eq_businessTypeCode_value??)>
${prefixName?string('WHERE ', 'AND ')}"business_type_code" = :where_and_eq_businessTypeCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("business_type_code" IS NULL OR "business_type_code" = '')
</#if>
<#assign prefixName = false>
</#if>
