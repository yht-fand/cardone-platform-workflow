...
<#if (insert_businessId??) && (insert_businessId_value??)>
${prefixName?string('  ', ', ')}"business_id"
<#assign prefixName = false>
</#if>
<#if (insert_businessTypeCode??) && (insert_businessTypeCode_value??)>
...
<#if (insert_businessCode??) && (insert_businessCode_value??)>
${prefixName?string('  ', ', ')}:insert_businessCode_value
<#assign prefixName = false>
</#if>
<#if (insert_businessId??) && (insert_businessId_value??)>
${prefixName?string('  ', ', ')}:insert_businessId_value
<#assign prefixName = false>
</#if>
<#if (insert_businessTypeCode??) && (insert_businessTypeCode_value??)>
${prefixName?string('  ', ', ')}:insert_businessTypeCode_value
<#assign prefixName = false>
</#if>
<#if (insert_createdByCode??) && (insert_createdByCode_value??)>
...
WHERE NOT EXISTS (SELECT 1 FROM "c1_wf_task_handle" E
<#assign prefixName = true>
...
<#if (where_and_eq_businessCode??)>
<#if (where_and_eq_businessCode_value??)>
${prefixName?string('WHERE ', 'AND ')}E."business_code" = :where_and_eq_businessCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E."business_code" IS NULL OR E."business_code" = '')
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_businessId??)>
<#if (where_and_eq_businessId_value??)>
${prefixName?string('WHERE ', 'AND ')}E."business_id" = :where_and_eq_businessId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E."business_id" IS NULL OR E."business_id" = '')
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_businessTypeCode??)>
<#if (where_and_eq_businessTypeCode_value??)>
${prefixName?string('WHERE ', 'AND ')}E."business_type_code" = :where_and_eq_businessTypeCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E."business_type_code" IS NULL OR E."business_type_code" = '')
</#if>
<#assign prefixName = false>
</#if>
