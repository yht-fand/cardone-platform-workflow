...
<#if (select_businessCode??)>
${prefixName?string('  ', ', ')}"business_code"
<#assign prefixName = false>
</#if>
<#if (select_businessId??)>
${prefixName?string('  ', ', ')}"business_id"
<#assign prefixName = false>
</#if>
<#if (select_businessTypeCode??)>
...
<#if (order_by_businessCode??)>
${prefixName?string('ORDER BY ', ', ')}"business_code" ${order_by_businessCode_value!}
<#assign prefixName = false>
</#if>
<#if (order_by_businessId??)>
${prefixName?string('ORDER BY ', ', ')}"business_id" ${order_by_businessId_value!}
<#assign prefixName = false>
</#if>
<#if (order_by_businessTypeCode??)>
${prefixName?string('ORDER BY ', ', ')}"business_type_code" ${order_by_businessTypeCode_value!}
<#assign prefixName = false>
</#if>
