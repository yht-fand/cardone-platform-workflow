...
<#if (where_and_nq_wfVariableId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_wfVariableId_value??)>
${prefixName} `WF_VARIABLE_ID` <> :where_and_nq_wfVariableId_value
<#else>
${prefixName} `WF_VARIABLE_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_wfVariableId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_wfVariableId_value??)>
${prefixName} `WF_VARIABLE_ID` <> :where_and_like_wfVariableId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_wfVariableId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_wfVariableId_value??)>
${prefixName} `WF_VARIABLE_ID` = :where_or_eq_wfVariableId_value
<#else>
${prefixName} `WF_VARIABLE_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_wfVariableId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_wfVariableId_value??)>
${prefixName} `WF_VARIABLE_ID` <> :where_or_nq_wfVariableId_value
<#else>
${prefixName} `WF_VARIABLE_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_wfVariableId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_wfVariableId_value??)>
${prefixName} `WF_VARIABLE_ID` like :where_or_like_wfVariableId_value
</#if>
<#assign prefixName = ''>
</#if>
