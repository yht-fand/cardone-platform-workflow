...
public class SystemRunVo implements java.io.Serializable {
	 ...
	 *            目录
	 */
	public void setDirectoryDto(final DirectoryDto directoryDto) {
	 ...
	 *            目录字段
	 */
	public void setDirectoryFieldDto(final DirectoryFieldDto directoryFieldDto) {
	 ...
	 *            分区
	 */
	public void setPartitionDto(final PartitionDto partitionDto) {
	 ...
	 *            分区字段
	 */
	public void setPartitionFieldDto(final PartitionFieldDto partitionFieldDto) {
	 ...
	 *            资源
	 */
	public void setResourceDto(final ResourceDto resourceDto) {
	 ...
	 *            资源字段
	 */
	public void setResourceFieldDto(final ResourceFieldDto resourceFieldDto) {
