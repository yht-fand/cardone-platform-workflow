...
<#if (where__and__eq__resourceCo??)>
	<#if (where__and__eq__resourceCo__value??)>
${prefixName} RESOURCE_CO_ = :where__and__eq__resourceCo__value
	<#else>
${prefixName} RESOURCE_CO_ IS NULL
	</#if>
	<#assign prefixName='AND'>
</#if>
